	...
	public WeightGraph(User user) {
		...
		btnShowGraph.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				JFreeChart chart = ChartFactory.createLineChart("Daily Weight Graph", "Date", "Weight", dataset,PlotOrientation.VERTICAL,false,true,true);
		...
		cbUnit.setModel(new DefaultComboBoxModel(new String[] {"lb", "kg"}));
